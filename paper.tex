...
The experiment requires Python 3.10 or later and PyTorch. No GPU is needed. Each model variant consists of four files: the model definition, the embedding and tokenizer module, the training script, and an interactive chat interface. The two variants differ only in the model definition file; all other files are shared.
